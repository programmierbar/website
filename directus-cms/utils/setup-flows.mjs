...
// Note: Content generation is now handled by the content-generation Directus hook
// The "Process Transcript Upload" flow is no longer needed
...
async function main() {
    ...
    try {
        ...
        console.log('\n=== Setup Complete ===');
        console.log('\nNote: Content generation is handled by the content-generation Directus hook.');
        console.log('Make sure GEMINI_API_KEY is set in your Directus environment.');
    } catch (error) {
