...
export async function getPodcastData(
    ...
    // due to this bug: https://github.com/directus/directus/issues/21689
    try {
        // Log start info
        ...
        pickOfTheDayItems = await Promise.all(
        ...
        logger.error(`${HOOK_NAME} hook: Could not query picks of the day "${error.message}"`)
    }
