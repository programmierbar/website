            ...
            <section v-if="conference.tickets_on_sale" class="relative">
                <div class="container mt-16 px-6 md:mt-28 md:pl-48 lg:mt-32 lg:pr-8 3xl:px-8">
                    ...
                    <ConferenceTickets
                        ...
                        :tickets-on-sale="conference.tickets_on_sale"
                        :tickets-url="conference.tickets_url"
                    />

                    <div v-if="conference.tickets_url" class="space mt-8 flex flex-row flex-wrap justify-around">
                        <a
                            :href="conference.tickets_url"
                            target="_blank"
                            data-cursor-hover
                            class="m-auto rounded-full border-4 border-lime px-8 py-4 text-left text-sm text-lime"
                            type="submit"
                        >
                            <div class="flex flex-row">
                                <div>
                                    <span class="text-xl font-bold uppercase md:text-4xl">Zu den Tickets</span>
                                ...
                                <div class="pl-4 md:pl-12">
                                    ...
                                    >
                                        <path
                                            d="M14.5378 17.334L47.7277 17.334L47.7291 50.9206"
                                            stroke="#CFFF00"
                                            stroke-width="5.34"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            d="M14.8991 46.5993C13.8564 47.642 13.8564 49.3326 14.8991 50.3753C15.9418 51.418 17.6324 51.418 18.6751 50.3753L14.8991 46.5993ZM47.6378 17.6366L45.7498 15.7486L14.8991 46.5993L16.7871 48.4873L18.6751 50.3753L49.5258 19.5246L47.6378 17.6366Z"
                                            fill="#CFFF00"
                                        />
                                    </svg>
                                </div>
...
import type { ConferenceItem, DirectusConferencePage, DirectusFileItem, DirectusTestimonialItem } from '~/types'
