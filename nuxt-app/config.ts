...
// Vanity-domain redirects (resolved in server/utils/redirects.ts)
export const CFP_FORM_URL =
    'https://docs.google.com/forms/d/e/1FAIpQLSdswI25P39NaWoH1BP5XCBzvSfcH1ATPbW6YtBMBa6cfGuhdQ/viewform?usp=header'
export const CONFERENCE_VANITY_HOSTS = [
    'con.programmier.bar',
    'conference.programmier.bar',
    'konferenz.programmier.bar',
]
export const CONFERENCE_LANDING_URL = 'https://programmier.bar/konferenz/programmier-con-2026-web-ai-edition'
export const FLUTTERDAY_LANDING_URL = 'https://programmier.bar/konferenz/flutter-day-2024'
...
export const OPEN_SPEAKER_MASTODON_EVENT_ID = 'OPEN_SPEAKER_MASTODON'
...
export const OPEN_MEMBER_WEBSITE_EVENT_ID = 'OPEN_MEMBER_WEBSITE'
export const OPEN_MEMBER_MASTODON_EVENT_ID = 'OPEN_MEMBER_MASTODON'
export const OPEN_MEMBER_GITHUB_EVENT_ID = 'OPEN_MEMBER_GITHUB'
export const OPEN_MEMBER_YOUTUBE_EVENT_ID = 'OPEN_MEMBER_YOUTUBE'
export const OPEN_MEMBER_INSTAGRAM_EVENT_ID = 'OPEN_MEMBER_INSTAGRAM'
export const OPEN_MEMBER_TWITTER_EVENT_ID = 'OPEN_MEMBER_TWITTER'
export const OPEN_MEMBER_LINKEDIN_EVENT_ID = 'OPEN_MEMBER_LINKEDIN'
export const OPEN_MEMBER_BLUESKY_EVENT_ID = 'OPEN_MEMBER_BLUESKY'
