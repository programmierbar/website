...
.text-input {
  @apply w-full appearance-none bg-gray-600 border-2 border-gray-600 rounded-none text-white text-base md:text-xl lg:text-2xl font-light p-4 md:p-6 lg:p-8;
}
