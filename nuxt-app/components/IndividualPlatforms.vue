  ...
  return [
    {
      name: 'Bluesky',
      icon: BLUESKY_ICON,
      url: normalizeExternalUrl(props.platforms.bluesky_url),
      eventId: BLUESKY_EVENT_ID,
    },
    {
      name: 'Mastodon',
      icon: MastodonIcon,
      url: normalizeExternalUrl(props.platforms.mastodon_url),
      eventId: MASTODON_EVENT_ID,
    },
    {
      name: 'LinkedIn',
      icon: LINKEDIN_ICON,
      url: normalizeExternalUrl(props.platforms.linkedin_url),
      eventId: LINKEDIN_EVENT_ID,
    },
    {
      name: 'Instagram',
      icon: INSTAGRAM_ICON,
      url: normalizeExternalUrl(props.platforms.instagram_url),
      eventId: INSTAGRAM_EVENT_ID,
    },
    {
      name: 'GitHub',
      icon: GITHUB_ICON,
      url: normalizeExternalUrl(props.platforms.github_url),
      eventId: GITHUB_EVENT_ID,
    },
    {
      name: 'YouTube',
      icon: YOUTUBE_ICON,
      url: normalizeExternalUrl(props.platforms.youtube_url),
      eventId: YOUTUBE_EVENT_ID,
    },
    {
      name: 'Website',
      icon: WEBSITE_ICON,
      url: normalizeExternalUrl(props.platforms.website_url),
      eventId: WEBSITE_EVENT_ID,
    },
    {
      name: 'Twitter',
      icon: TWITTER_ICON,
      url: normalizeExternalUrl(props.platforms.twitter_url),
